...
export default function Footer() {
  return (
    <footer className="bg-[#EFF6FF] text-slate-700 border-t border-sky-200">
      ...
      <div className="bg-white leading-none">
        <svg viewBox="0 0 1440 50" preserveAspectRatio="none" style={{ width: '100%', height: '50px', display: 'block' }}>
          <path d="M0 0C360 50 1080 50 1440 0V50H0V0Z" fill="#EFF6FF" />
        </svg>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="#" className="w-9 h-9 bg-sky-500 hover:bg-sky-600 rounded-lg flex items-center justify-center transition-colors" aria-label="Facebook">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                </svg>
              </a>
              <a href="#" className="w-9 h-9 bg-sky-500 hover:bg-sky-600 rounded-lg flex items-center justify-center transition-colors" aria-label="Instagram">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* ── Quick Links ── */}
          <div>
            <h3 className="text-sky-700 text-sm font-bold uppercase tracking-wider mb-5">Quick Links</h3>
            <ul className="space-y-2.5 text-sm">
              {[
                ...
                <li key={link.label}>
                  <Link href={link.path} className="text-slate-600 hover:text-sky-600 transition-colors font-medium">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* ── Services ── */}
          <div>
            <h3 className="text-sky-700 text-sm font-bold uppercase tracking-wider mb-5">Our Services</h3>
            <ul className="space-y-2.5 text-sm">
              {[
          ...
          {/* ── Contact ── */}
          <div>
            <h3 className="text-sky-700 text-sm font-bold uppercase tracking-wider mb-5">Contact Us</h3>
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+918779648573" className="text-slate-700 hover:text-sky-600 transition-colors font-semibold">
                  +91 877-9648573
                </a>
              </li>
              <li className="flex items-start gap-3">
        ...
        <div className="border-t border-sky-200 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-slate-500">
          ...
          <p className="text-sky-600 font-medium">Advanced Dental Clinic, Panvel</p>
        </div>
      </div>
    </footer>
  );
