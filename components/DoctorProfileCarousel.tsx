  ...
  return (
    <section className="bg-white py-16">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {/* Outer wrapper: relative so mobile arrows can escape overflow-hidden card */}
        <div className="relative">
          ...
          {/* Mobile-only arrows: outside overflow-hidden, positioned over image area */}
          {/* Image area is h-[360px] on mobile, so top-[180px] = vertical center */}
          <button
            onClick={prevSlide}
            type="button"
            aria-label="Previous"
            className="md:hidden absolute left-3 top-[180px] -translate-y-1/2 z-30 w-10 h-10 rounded-full bg-sky-600 text-white flex items-center justify-center shadow-lg"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
            </svg>
          ...
          <button
            ...
            type="button"
            aria-label="Next"
            className="md:hidden absolute right-3 top-[180px] -translate-y-1/2 z-30 w-10 h-10 rounded-full bg-sky-600 text-white flex items-center justify-center shadow-lg"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
